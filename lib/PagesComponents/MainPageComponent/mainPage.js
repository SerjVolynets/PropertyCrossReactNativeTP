...
const asyncGetData_1 = require("../../helpres/asyncGetData");
...
class MainPage extends React.Component {
    ...
    componentDidMount() {
        asyncGetData_1.default().then((value) => { this.props.createFavListFromAsyncStorage(value); });
    }
    render() {
...
exports.default = react_redux_1.connect(mapStateToProps, {
    ...
    createFavListFromAsyncStorage: actions_1.createFavListFromAsyncStorage,
})(MainPage);
