...
class SearchResultPage extends React.Component {
    constructor() {
        super(...arguments);
        this.renderPart = () => {
            return (this.props.responseProperty.map((obj, index) => (React.createElement(react_native_gesture_handler_1.TouchableOpacity, { onPress: () => (this.props.addDataWithCurrentProperty(index), this.props.navigation.navigate('CurrentPage')) },
                React.createElement(listReasultToken_1.default, { key: index, src: obj.img_url, name: obj.price, dis: obj.title })))));
        };
    }
    render() {
